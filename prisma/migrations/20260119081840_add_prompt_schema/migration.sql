...
-- Backfill existing notes with a seed owner
INSERT INTO "User" ("id", "email", "name", "createdAt")
VALUES ('seed_owner', 'seed@example.com', 'Seed User', CURRENT_TIMESTAMP);

UPDATE "Note" SET "ownerId" = 'seed_owner' WHERE "ownerId" IS NULL;
